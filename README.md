...
输入资料 → 生成一份可直接演示、可交互、可持续编辑的 HTML 幻灯片
...
三个工具各司其职，理解之后才知道"AI 做 PPT"不是一句 prompt 的事。
...
| Agent 2 · 结构架构 | 逐页大纲、核心问题、时间分配、叙事弧 | 页码强约束，每页只回答一个问题 |
...
## 关于作者
wilingna ([@wilingna](https://github.com/wilingna))，大厂HR出身的AI Systems Architect，做 AI 工作流 / 中国传统美学数字文化出海。
